...
<div style="background: linear-gradient(to right, rgba(0,0,0,0.8) 375px, rgba(0,0,0,0) 1000px); width: 100%; height: 100%; position: fixed; top: 0; right: 0; z-index: -1;"></div>
